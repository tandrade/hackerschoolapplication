 ...
 */
	...
	private GObject getCollidingObject() { 
		GObject objtop1 = getElementAt(ball.getX(), ball.getY() - BALL_RADIUS/2);
		GObject objtop2 = getElementAt(ball.getX() + 2*BALL_RADIUS, ball.getY() - BALL_RADIUS/2);
	...
	private void checkObjCollision() { 
		...
		if (collision != null && collision != box) {  
			remove(collision);
			dy = VEL; 
		}
	}
